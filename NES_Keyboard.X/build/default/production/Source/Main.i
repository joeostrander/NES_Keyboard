...
# 38 "Source/UsbDescriptors.h"
volatile uint8_t HIDRxBuffer[0x08];
volatile uint8_t HIDTxBuffer[0x08];

BufferInfo Buffers[(0x01 * 2)] =
{
    { 0x08, (uint8_t*)&HIDTxBuffer },
    { 0x08, (uint8_t*)&HIDRxBuffer }
};
...
# 1 "Source/usb_hid_keys.h" 1
# 4 "Source/nes_keyboard.h" 2
# 15 "Source/nes_keyboard.h"
struct KEYMAP
{
 uint8_t button;
 uint16_t key;
...
void PrepareTxBuffer(uint8_t keypad_reading)
{
    ...
    if ( keypad_reading > 0)
    {
        ...
        while( button_key_maps[i].button != ((void*)0) )
        {
